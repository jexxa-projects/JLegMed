package io.jexxa.jlegmed.common.component.persistence.objectstore;
...
{
    /**
     * Get all values that fulfill: {@code value <= metadata of the object}. The returned list is in ascending
    ...
    /**
     * Get all values that fulfill: {@code value < returnedValue}. The returned list is in ascending
     * order by numeric representation of used value.
     *
    ...
    /**
     * Return all elements not equal to S. The returned list is in ascending
     * order by numeric representation of used value.
     *
     * @pre value must not be null
     * @param value specifies comparison value
    ...
    /**
     *  Get all values that fulfill: {@code startValue <= value <= endValue}. The returned list is in ascending
     *  order by numeric representation of used value.
     *
