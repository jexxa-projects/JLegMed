...
public class Multiplexer {
    ...
    {
        return new SynchronizedMultiplexer<>(methodNameFromLambda(multiplexFunction), muxTimeout) {
            @Override
    ...
    {
        return new ThreadedMultiplexer<>(methodNameFromLambda(multiplexFunction)) {
            @Override
            public R multiplexData(U firstData, V secondData) {
                return multiplexFunction.apply(firstData, secondData);
            }
