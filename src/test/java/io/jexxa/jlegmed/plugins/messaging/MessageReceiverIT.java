...
import static io.jexxa.jlegmed.plugins.messaging.producer.jms.JMSProducer.jmsTopicAsJSON;
...
class MessageReceiverIT {
    ...
    void testAsyncProcessing() {
        ...
        jlegmed.newFlowGraph("Async MessageReceiver")
                ...
                .await(Integer.class).from(jmsTopicAsJSON("MyTopic")).useProperties("test-jms-connection")
